...
class TextFromFieldNumber extends StatefulWidget {
  ...
  @override
  State<TextFromFieldNumber> createState() => _TextFromFieldNumberState();
}

class _TextFromFieldNumberState extends State<TextFromFieldNumber> {
  ...
  @override
  void didUpdateWidget(TextFromFieldNumber oldWidget) {
